...
export default function AboutUs() {
  return (
    <div className="w-full flex flex-col gap-32">
      {/* Top Section */}
      <section className="w-full bg-blue-100/50 py-28">
        <div className="max-w-7xl mx-auto px-6 md:px-20 lg:px-32 flex flex-col md:flex-row items-center justify-between">
          <div className="max-w-2xl space-y-6">
            ...
            <button className="mt-4 bg-purple-500 text-white px-8 py-3 rounded-xl shadow hover:bg-purple-700 transition">
              Learn More
            </button>
          </div>
          ...
          <img
            ...
            className="w-64 md:w-96 mt-10 md:mt-0 drop-shadow-lg"
          />
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-20 lg:px-32 grid md:grid-cols-2 gap-16">
        <div className="p-8 bg-white rounded-2xl shadow-md space-y-4 border border-gray-200">
      ...
      <section className="w-full max-w-6xl mx-auto py-12">
        <h2 className="text-center text-xl font-semibold mb-10">Our Teams</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="relative h-80 rounded-xl shadow-md overflow-hidden bg-cover bg-center group"
            ...
            >
              ...
              {/* Text on top */}
              <div className="absolute bottom-4 left-0 right-0 text-center text-white px-3">
